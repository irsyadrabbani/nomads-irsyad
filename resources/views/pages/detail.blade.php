                        ...
                        <div class="col-lg-4">
                            <div class="card card-details card-right">
                                ...
                                <div class="members my-2">
                                    <img src="/frontend/images/members-1.png" class="members-images mr-1">
                                    <img src="/frontend/images/members-2.png" class="members-images mr-1">
                                    <img src="/frontend/images/members-3.png" class="members-images mr-1">
                                    <img src="/frontend/images/members-4.png" class="members-images mr-1">
                                    <img src="/frontend/images/members-5.png" class="members-images mr-1">
                                </div>
                                <hr>
                            ...
                            <div class="join-container">
                                @auth
                                    <form action="{{ route('checkout_procces', $item->id) }}" method="POST">
                                        @csrf
