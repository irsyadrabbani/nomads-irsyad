                        ...
                        <div class="col-lg-8 pl-lg-0">
                            ...
                            <div class="member-mt-3">
                                ...
                                <form action="{{ route('checkout-create', $item->id) }}" class="form-inline" method="POST">
                                    ...
                                    <label for="is_visa" class="sr-only">Name</label>
                                        ...
                                        <div class="input-group mb-2 mr-sm-2">
                                            <input type="text" class="form-control datepicker" id="doe_passport" placeholder="DOE Passport"
                                            name="doe_passport" style="width: 120px">
                                        </div>
